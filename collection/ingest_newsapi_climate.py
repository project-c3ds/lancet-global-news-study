#!/usr/bin/env python3
"""Ingest NewsAPI-collected climate articles into climate.db.

Reads from data/newsapi_articles_{year}/*_climate.jsonl (produced by
collect_newsapi_climate.py) and inserts into SQLite.

Usage:
    python collection/ingest_newsapi_climate.py --year 2025
    python collection/ingest_newsapi_climate.py --year 2024 --source nytimes.com
    python collection/ingest_newsapi_climate.py --year 2025 --dry-run
"""
