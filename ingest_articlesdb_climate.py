...
Usage:
    python ingest_scrapai_climate.py
    python ingest_scrapai_climate.py --language English
    python ingest_scrapai_climate.py --source eltiempo.com
    python ingest_scrapai_climate.py --dry-run
"""
